...
public class Capitalize {
	...
	public static String capitalize(String phrase) {
		...
		for (int i = 0; i < arrayOfWords.length; i++) {
			 ...
			 * concatenate it with the rest of the String. We then rewrite this new concatenated String back to its
			 * original position.
			 * 
			 * Citation: This code was partially based upon code produced by Rekin & Jens Piegsa (2010, 2015,
			 * 			 repsectively) (https://stackoverflow.com/questions/3904579/how-to-capitalize-the-first-letter-of-a-string-in-java).
			 * 
			 */
